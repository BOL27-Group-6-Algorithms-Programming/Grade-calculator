...
int main()
{
    ...
    for (int i = 0; i < 100 && lanjut; i++)
    {
        ...
        do
        {
            ...
            {
                printf("Harap masukan nilai didalam jangkauan 1-100!\n");
                isNilaiValid = false;
            }
            else
            {
        ...
        printf("\nApakah anda ingin memasukan data mahasiswa lagi (Y/N)? ");
        scanf(" %c", &opsi);
        ...
        {
            printf("Masukan minimal 10 data mahasiswa!\n");
        }
